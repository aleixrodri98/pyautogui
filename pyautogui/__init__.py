...
class PyAutoGui(object):
    ...
    def getPointOnLine(self, x1, y1, x2, y2, n):
        """
    ...
    def _normalizeXYArgs(self, firstArg, secondArg):
        """
        ...
        if firstArg is None and secondArg is None:
            ...
            try:
                location = self.locateOnScreen(firstArg)
                ...
                if location is not None:
                    return self.center(location)
                else:
                    return None
            except pyscreeze.ImageNotFoundException:
                raise ImageNotFoundException

            return self.center(locateOnScreen(firstArg))
    ...
    def _logScreenshot(self, logScreenshot, funcName, funcArgs, folder="."):
        """
    ...
    def position(self, x=None, y=None):
        ...
        """
        posx, posy = self.platformModule._position()
        posx = int(posx)
        posy = int(posy)
    ...
    def size(self):
        ...
        """
        return Size(*self.platformModule._size())
    ...
    def _normalizeButton(self, button):
        """
    ...
    def mouseDown(self, x=None, y=None, button=PRIMARY, duration=0.0, tween=linear, logScreenshot=None, _pause=True):
        ...
        """
        button = self._normalizeButton(button)
        x, y = self._normalizeXYArgs(x, y)

        self._mouseMoveDrag("move", x, y, 0, 0, duration=0, tween=None)

        self._logScreenshot(logScreenshot, "mouseDown", "%s,%s" % (x, y), folder=".")
        self.platformModule._mouseDown(x, y, button)

    def mouseUp(self, x=None, y=None, button=PRIMARY, duration=0.0, tween=linear, logScreenshot=None, _pause=True):
        ...
        self._logScreenshot(logScreenshot, "mouseUp", "%s,%s" % (x, y), folder=".")
        self.platformModule._mouseUp(x, y, button)


    def click(
        self, x=None, y=None, clicks=1, interval=0.0, button=PRIMARY, duration=0.0, tween=linear, logScreenshot=None, _pause=True
    ):
        """
        ...
        self._mouseMoveDrag("move", x, y, 0, 0, duration, tween)

        self._logScreenshot(logScreenshot, "click", "%s,%s,%s,%s" % (button, clicks, x, y), folder=".")

        if sys.platform == 'darwin':
            for i in range(clicks):
                self.failSafeCheck()
                if button in (LEFT, MIDDLE, RIGHT):
                    self.platformModule._multiClick(x, y, button, 1, interval)
        else:
            for i in range(clicks):
                self.failSafeCheck()
                if button in (LEFT, MIDDLE, RIGHT):
                    self.platformModule._click(x, y, button)

                time.sleep(interval)


    def leftClick(self, x=None, y=None, interval=0.0, duration=0.0, tween=linear, logScreenshot=None, _pause=True):
        ...
        self.click(x, y, 1, interval, LEFT, duration, tween, logScreenshot, _pause=_pause)


    def rightClick(self, x=None, y=None, interval=0.0, duration=0.0, tween=linear, logScreenshot=None, _pause=True):
        ...
        Returns:
          None
        """
        self.click(x, y, 1, interval, RIGHT, duration, tween, logScreenshot, _pause=_pause)


    def middleClick(self, x=None, y=None, interval=0.0, duration=0.0, tween=linear, logScreenshot=None, _pause=True):
        ...
        Returns:
          None
        """
        self.click(x, y, 1, interval, MIDDLE, duration, tween, logScreenshot, _pause=_pause)


    def doubleClick(self, x=None, y=None, interval=0.0, button=LEFT, duration=0.0, tween=linear, logScreenshot=None, _pause=True):
        ...
        if sys.platform == "darwin":
            x, y = self._normalizeXYArgs(x, y)
            self._mouseMoveDrag("move", x, y, 0, 0, duration=0, tween=None)
            x, y = self.platformModule._position()
            self.platformModule._multiClick(x, y, button, 2)
            self._logScreenshot(logScreenshot, 'click', '%s,2,%s,%s' % (button, x, y), folder='.')
        else:
            # Click for Windows or Linux:
            self.click(x, y, 2, interval, button, duration, tween, logScreenshot, _pause=False)


    def tripleClick(self, x=None, y=None, interval=0.0, button=LEFT, duration=0.0, tween=linear, logScreenshot=None, _pause=True):
        ...
        if sys.platform == "darwin":
            ...
            self._mouseMoveDrag("move", x, y, 0, 0, duration=0, tween=None)
            x, y = self.platformModule._position()
            self._logScreenshot(logScreenshot, "click", "%s,3,%s,%s" % (x, y), folder=".")
            self.platformModule._multiClick(x, y, button, 3)
        else:
            # Click for Windows or Linux:
            self.click(x, y, 3, interval, button, duration, tween, logScreenshot, _pause=False)


    def scroll(self, clicks, x=None, y=None, logScreenshot=None, _pause=True):
        ...
        self._logScreenshot(logScreenshot, "scroll", "%s,%s,%s" % (clicks, x, y), folder=".")
        self.platformModule._scroll(clicks, x, y)


    def hscroll(self, clicks, x=None, y=None, logScreenshot=None, _pause=True):
        ...
        self._logScreenshot(logScreenshot, "hscroll", "%s,%s,%s" % (clicks, x, y), folder=".")
        self.platformModule._hscroll(clicks, x, y)


    def vscroll(self, clicks, x=None, y=None, logScreenshot=None, _pause=True):
        ...
        self._logScreenshot(logScreenshot, "vscroll", "%s,%s,%s" % (clicks, x, y), folder=".")
        self.platformModule._vscroll(clicks, x, y)


    def moveTo(self, x=None, y=None, duration=0.0, tween=linear, logScreenshot=False, _pause=True):
        ...
        self._logScreenshot(logScreenshot, "moveTo", "%s,%s" % (x, y), folder=".")
        self._mouseMoveDrag("move", x, y, 0, 0, duration, tween)


    def moveRel(self, xOffset=None, yOffset=None, duration=0.0, tween=linear, logScreenshot=False, _pause=True):
        ...
        Returns:
          None
        """
        xOffset, yOffset = self._normalizeXYArgs(xOffset, yOffset)

        self._logScreenshot(logScreenshot, "moveRel", "%s,%s" % (xOffset, yOffset), folder=".")
        self._mouseMoveDrag("move", None, None, xOffset, yOffset, duration, tween)


    def dragTo(
        self, x=None, y=None, duration=0.0, tween=linear, button=PRIMARY, logScreenshot=None, _pause=True, mouseDownUp=True
    ):
        ...
        self._logScreenshot(logScreenshot, "dragTo", "%s,%s" % (x, y), folder=".")
        if mouseDownUp:
            self.mouseDown(button=button, logScreenshot=False, _pause=False)
        self._mouseMoveDrag("drag", x, y, 0, 0, duration, tween, button)
        if mouseDownUp:
            self.mouseUp(button=button, logScreenshot=False, _pause=False)


    def dragRel(
        self, xOffset=0, yOffset=0, duration=0.0, tween=linear, button=PRIMARY, logScreenshot=None, _pause=True, mouseDownUp=True
    ):
        """Performs a mouse drag (mouse movement while a button is held down) to a
        ...
        mousex, mousey = self.platformModule._position()
        self._logScreenshot(logScreenshot, "dragRel", "%s,%s" % (xOffset, yOffset), folder=".")
        if mouseDownUp:
            self.mouseDown(button=button, logScreenshot=False, _pause=False)
        self._mouseMoveDrag("drag", mousex, mousey, xOffset, yOffset, duration, tween, button)
        if mouseDownUp:
            self.mouseUp(button=button, logScreenshot=False, _pause=False)


    def _mouseMoveDrag(self, moveOrDrag, x, y, xOffset, yOffset, duration, tween=linear, button=None):
        ...
        if duration > MINIMUM_DURATION:
            ...
            human_curve = HumanCurve((startx, starty), (x, y), distortionMean=2, distortionStdev=2, distortionFrequency=0.7, targetPoints=70)
        ...
        for tweenX, tweenY in steps:
            ...
            if (tweenX, tweenY) not in self.FAILSAFE_POINTS:
                self.failSafeCheck()

            if moveOrDrag == "move":
                self.platformModule._moveTo(tweenX, tweenY)
            elif moveOrDrag == "drag":
                self.platformModule._dragTo(tweenX, tweenY, button)
            else:
    ...
    def isValidKey(self, key):
        ...
        """
        return self.platformModule.keyboardMapping.get(key, None) != None
    ...
    def keyDown(self, key, logScreenshot=None, _pause=True):
        ...
        self._logScreenshot(logScreenshot, "keyDown", key, folder=".")
        self.platformModule._keyDown(key)
    ...
    def keyUp(self, key, logScreenshot=None, _pause=True):
        ...
        self._logScreenshot(logScreenshot, "keyUp", key, folder=".")
        self.platformModule._keyUp(key)


    def press(self, keys, presses=1, interval=0.0, logScreenshot=None, _pause=True):
        ...
        self._logScreenshot(logScreenshot, "press", ",".join(keys), folder=".")
        for i in range(presses):
            for k in keys:
                self.failSafeCheck()
                self.platformModule._keyDown(k)
                self.platformModule._keyUp(k)
            time.sleep(interval)


    @contextmanager
    def hold(self, keys, logScreenshot=None, _pause=True):
    ...
    def typewrite(self, message, interval=0.0, logScreenshot=None, _pause=True):
        ...
        self._logScreenshot(logScreenshot, "write", message, folder=".")
        for c in message:
            if len(c) > 1:
                c = c.lower()
            self.press(c, _pause=False)
            time.sleep(interval)
            self.failSafeCheck()
    ...
    def hotkey(self, *args, **kwargs):
        ...
        self._logScreenshot(kwargs.get("logScreenshot"), "hotkey", ",".join(args), folder=".")
        for c in args:
            if len(c) > 1:
                c = c.lower()
            self.platformModule._keyDown(c)
            time.sleep(interval)
        for c in reversed(args):
            if len(c) > 1:
                c = c.lower()
            self.platformModule._keyUp(c)
            time.sleep(interval)


    def failSafeCheck(self):
        if FAILSAFE and tuple(self.position()) in self.FAILSAFE_POINTS:
    ...
    def displayMousePosition(self, xOffset=0, yOffset=0):
    ...
    def _snapshot(self, tag, folder=None, region=None, radius=None):
